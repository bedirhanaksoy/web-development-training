...
<body>
  ...
  <nav>
            ...
            <div classname="my-10 ">
                <div class="flex flex-col items-center justify-center my-8">
                    ...
                    <form id="updateTopic" action="" method="post" onsubmit="return validateUpdateTopic()">
                        ...
                        <input type="hidden" name="update_topic_id" id="update_topic_id" class="border rounded-md border-gray-300 p-2" ><br><br>
    ...
    <script>
        ...
        var topicTitle = urlParams.get('title');
        var topicCategoryId = urlParams.get('categoryID');
        var topicId = urlParams.get('topicID');
        var topicContent = urlParams.get('content');

        document.getElementById("update_topic_title").value = topicTitle;
        document.getElementById("update_topic_category_id").value = topicCategoryId;
        document.getElementById("update_topic_id").value = topicId;
        document.getElementById("update_topic_content").value = topicContent;
    </script>
