...
<body>
  ...
  <div class="flex-container content" id="categories">
        <div class="left">
            <button onclick="openCreateCategory();" class="topicButton">Create New Category</button>
        </div>
        <div>
    ...
    <div class="flex-container content" id="topics">
        <div>
            <button onclick="openCreateTopic();" class="topicButton">Create New Topic</button>
