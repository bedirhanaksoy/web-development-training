...
<?php
    ...
    header('Location: ./pages/cmsHomePage.php');
    }
?>
    ...
    <div classname="my-10 ">
        <div class="flex flex-col items-center justify-center my-8">
            ...
            <form id="create" action="" method="post" onsubmit="return validateLogin()">
                ...
                <input type="password" name="password" id="login_password" class="border rounded-md border-gray-300 p-2" ><br><br>
            ...
            <label for="myLink">Don't have an account, <a href="api/signin.html" class="text-blue-500">Sign In</a></label>
        </div>
    </div>
</html>